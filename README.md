...
- requirements.txt: Packages used in the project are present in the this file . While clone the repo ,it's suggested that one should , firstly run this file. ```bash pip install -r requirements.txt ```
